 ...
 */
public class GoogleSignInActivity extends Activity implements FirebaseAuth.AuthStateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.sign_out_button).setOnClickListener((View view) -> {
            signOut();
        });
    ...
    private void updateUI(FirebaseUser user) {
        final TextView usernameTV = (TextView) findViewById(R.id.username_view);
        if (user == null) {
